...
CREATE TABLE `cms_member_report` (
  ...
  `report_object` varchar(100) DEFAULT NULL COMMENT '举报内容',
...
CREATE TABLE `oms_cart_item` (
  ...
  `product_sn` varchar(200) DEFAULT NULL COMMENT '商品编号',
...
CREATE TABLE `pms_brand` (
  ...
  `show_status` int(1) DEFAULT NULL COMMENT '显示状态',
...
CREATE TABLE `pms_comment` (
  ...
  `member_ip` varchar(64) DEFAULT NULL COMMENT '会员评价的ip',
  `create_time` datetime DEFAULT NULL,
  `show_status` int(1) DEFAULT NULL COMMENT '显示状态',
  `product_attribute` varchar(255) DEFAULT NULL COMMENT '购买时的商品属性',
  `collect_couont` int(11) DEFAULT NULL COMMENT '收藏数量',
  `read_count` int(11) DEFAULT NULL COMMENT '读取的数量',
  `content` text COMMENT '评论内容',
  `pics` varchar(1000) DEFAULT NULL COMMENT '上传图片地址，以逗号隔开',
  `member_icon` varchar(255) DEFAULT NULL COMMENT '评论用户头像',
  `replay_count` int(11) DEFAULT NULL COMMENT '回复的数量',
  PRIMARY KEY (`id`)
...
CREATE TABLE `pms_comment_replay` (
  ...
  `member_nick_name` varchar(255) DEFAULT NULL COMMENT '会员昵称',
  `member_icon` varchar(255) DEFAULT NULL COMMENT '会员头像(会员图标)',
...
CREATE TABLE `pms_product` (
  ...
  `detail_title` varchar(255) DEFAULT NULL COMMENT '商品详情标题',
...
CREATE TABLE `pms_product_attribute` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `product_attribute_category_id` bigint(20) DEFAULT NULL COMMENT '商品属性类目id',
  `name` varchar(64) DEFAULT NULL COMMENT '商品属性名称',
...
CREATE TABLE `pms_product_attribute_category` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `name` varchar(64) DEFAULT NULL COMMENT '商品属性类目名称',
...
CREATE TABLE `pms_product_attribute_value` (
  ...
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `product_id` bigint(20) DEFAULT NULL COMMENT '商品id',
  `product_attribute_id` bigint(20) DEFAULT NULL COMMENT '商品属性参数id',
...
CREATE TABLE `pms_product_category` (
  ...
  `name` varchar(64) DEFAULT NULL COMMENT '商品类目名称',
  `level` int(1) DEFAULT NULL COMMENT '分类级别：0->1级；1->2级',
  `show_status` int(1) DEFAULT NULL COMMENT '显示状态：0->不显示；1->显示',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `icon` varchar(255) DEFAULT NULL COMMENT '图标',
  `keywords` varchar(255) DEFAULT NULL COMMENT '商品类目关键字',
...
CREATE TABLE `pms_product_full_reduction` (
  ...
  `shop_id` bigint(20) DEFAULT NULL COMMENT '店铺id',
  `product_id` bigint(20) DEFAULT NULL COMMENT '商品id',
  `full_price` decimal(10,2) DEFAULT NULL COMMENT '未满减的商品价格',
  `reduce_price` decimal(10,2) DEFAULT NULL COMMENT '满减后的商品价格',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sms_advertise` (
  ...
  `pic` varchar(500) DEFAULT NULL COMMENT '广告位图片',
...
CREATE TABLE `sms_group_promotion_product_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='团购活动和商品关系表';
...
INSERT INTO `sys_dict_data` VALUES ('27', '0', '深圳市', '0755', 'sys_guangdong_city', '', 'default', 'Y', '0', 'admin', '2019-08-02 15:58:48', '', null, '');
...
INSERT INTO `sys_dict_type` VALUES ('10', '广东省地市明细', 'sys_guangdong_city', '0', 'admin', '2019-08-02 15:57:52', '', null, '广东省地市名称');
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES ('1', 'ryTask', '系统默认（无参）', 'ryNoParams', '', '0/10 * * * * ?', '0', '1', 'admin', '2018-03-16 11:33:00', 'admin', '2019-11-14 16:15:55', '');
...
-- ----------------------------
INSERT INTO `sys_job_log` VALUES ('1', 'ryTask', '系统默认（无参）', 'ryNoParams', null, 'ryTask 总共耗时：5毫秒', '0', '', '2019-11-14 16:15:40');
INSERT INTO `sys_job_log` VALUES ('2', 'ryTask', '系统默认（无参）', 'ryNoParams', null, 'ryTask 总共耗时：1毫秒', '0', '', '2019-11-14 16:15:50');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=299 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('263', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-02 09:46:28');
INSERT INTO `sys_logininfor` VALUES ('264', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-04 16:24:02');
INSERT INTO `sys_logininfor` VALUES ('265', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:18:22');
INSERT INTO `sys_logininfor` VALUES ('266', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:23:04');
INSERT INTO `sys_logininfor` VALUES ('267', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2019-11-04 21:27:40');
INSERT INTO `sys_logininfor` VALUES ('268', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:27:43');
INSERT INTO `sys_logininfor` VALUES ('269', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:34:29');
INSERT INTO `sys_logininfor` VALUES ('270', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2019-11-04 21:36:02');
INSERT INTO `sys_logininfor` VALUES ('271', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:36:05');
INSERT INTO `sys_logininfor` VALUES ('272', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '1', '验证码错误', '2019-11-04 21:37:09');
INSERT INTO `sys_logininfor` VALUES ('273', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:37:12');
INSERT INTO `sys_logininfor` VALUES ('274', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 21:39:20');
INSERT INTO `sys_logininfor` VALUES ('275', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 22:05:55');
INSERT INTO `sys_logininfor` VALUES ('276', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 22:33:29');
INSERT INTO `sys_logininfor` VALUES ('277', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '退出成功', '2019-11-04 22:34:45');
INSERT INTO `sys_logininfor` VALUES ('278', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-04 22:34:49');
INSERT INTO `sys_logininfor` VALUES ('279', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-05 12:38:44');
INSERT INTO `sys_logininfor` VALUES ('280', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-05 12:54:30');
INSERT INTO `sys_logininfor` VALUES ('281', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-11-05 13:54:57');
INSERT INTO `sys_logininfor` VALUES ('282', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-07 10:31:42');
INSERT INTO `sys_logininfor` VALUES ('283', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-14 16:15:18');
INSERT INTO `sys_logininfor` VALUES ('284', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-14 19:57:47');
INSERT INTO `sys_logininfor` VALUES ('285', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 13:44:46');
INSERT INTO `sys_logininfor` VALUES ('286', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '1', '验证码错误', '2019-11-18 13:50:13');
INSERT INTO `sys_logininfor` VALUES ('287', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '1', '验证码错误', '2019-11-18 13:50:16');
INSERT INTO `sys_logininfor` VALUES ('288', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 13:50:19');
INSERT INTO `sys_logininfor` VALUES ('289', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 13:57:18');
INSERT INTO `sys_logininfor` VALUES ('290', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 14:02:22');
INSERT INTO `sys_logininfor` VALUES ('291', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 14:03:54');
INSERT INTO `sys_logininfor` VALUES ('292', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '退出成功', '2019-11-18 14:05:09');
INSERT INTO `sys_logininfor` VALUES ('293', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 14:05:13');
INSERT INTO `sys_logininfor` VALUES ('294', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 14:09:11');
INSERT INTO `sys_logininfor` VALUES ('295', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '退出成功', '2019-11-18 14:09:23');
INSERT INTO `sys_logininfor` VALUES ('296', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 14:09:27');
INSERT INTO `sys_logininfor` VALUES ('297', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '退出成功', '2019-11-18 14:10:25');
INSERT INTO `sys_logininfor` VALUES ('298', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', '0', '登录成功', '2019-11-18 14:10:31');
...
INSERT INTO `sys_notice` VALUES ('2', '维护通知：2018-07-01 豆豆系统凌晨维护', '1', '维护内容<div><span style=\"color: rgb(255, 0, 0); font-weight: bold;\">很高兴大家一直以来的支持</span></div>', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2019-11-04 21:25:22', '管理员');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('1', '操作日志', '9', 'com.aaa.repast.admin.project.monitor.operlog.controller.OperlogController.clean()', '1', 'admin', '研发部门', '/monitor/operlog/clean', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:28:14');
INSERT INTO `sys_oper_log` VALUES ('2', '操作日志', '5', 'com.aaa.repast.admin.project.monitor.operlog.controller.OperlogController.export()', '1', 'admin', '研发部门', '/monitor/operlog/export', '127.0.0.1', '内网IP', '{\"title\":[\"\"],\"operName\":[\"\"],\"businessType\":[\"\"],\"params[beginTime]\":[\"\"],\"params[endTime]\":[\"\"]}', '0', null, '2019-11-04 21:28:19');
INSERT INTO `sys_oper_log` VALUES ('3', '参数管理', '5', 'com.aaa.repast.admin.project.system.config.controller.ConfigController.export()', '1', 'admin', '研发部门', '/system/config/export', '127.0.0.1', '内网IP', '{\"configName\":[\"\"],\"configKey\":[\"\"],\"configType\":[\"\"],\"params[beginTime]\":[\"\"],\"params[endTime]\":[\"\"]}', '0', null, '2019-11-04 21:28:46');
INSERT INTO `sys_oper_log` VALUES ('4', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2026', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:39:53');
INSERT INTO `sys_oper_log` VALUES ('5', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2026', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:39:57');
INSERT INTO `sys_oper_log` VALUES ('6', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2026', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:04');
INSERT INTO `sys_oper_log` VALUES ('7', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2014', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:14');
INSERT INTO `sys_oper_log` VALUES ('8', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2013', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:32');
INSERT INTO `sys_oper_log` VALUES ('9', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2012', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:37');
INSERT INTO `sys_oper_log` VALUES ('10', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2011', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:42');
INSERT INTO `sys_oper_log` VALUES ('11', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2010', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:46');
INSERT INTO `sys_oper_log` VALUES ('12', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2019', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:40:52');
INSERT INTO `sys_oper_log` VALUES ('13', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2019', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:41:05');
INSERT INTO `sys_oper_log` VALUES ('14', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2019', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:41:10');
INSERT INTO `sys_oper_log` VALUES ('15', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2018', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-04 21:41:18');
INSERT INTO `sys_oper_log` VALUES ('16', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/ums_shop_questionnaire_answer', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-05 12:54:40');
INSERT INTO `sys_oper_log` VALUES ('17', '代码生成', '8', 'com.aaa.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/sys_user', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-07 10:40:23');
INSERT INTO `sys_oper_log` VALUES ('18', '定时任务', '2', 'com.aaa.repast.admin.project.monitor.job.controller.JobController.changeStatus()', '1', 'admin', '研发部门', '/monitor/job/changeStatus', '127.0.0.1', '内网IP', '{\"jobId\":[\"1\"],\"status\":[\"0\"]}', '0', null, '2019-11-14 16:15:31');
INSERT INTO `sys_oper_log` VALUES ('19', '定时任务', '2', 'com.aaa.repast.admin.project.monitor.job.controller.JobController.changeStatus()', '1', 'admin', '研发部门', '/monitor/job/changeStatus', '127.0.0.1', '内网IP', '{\"jobId\":[\"1\"],\"status\":[\"1\"]}', '0', null, '2019-11-14 16:15:55');
INSERT INTO `sys_oper_log` VALUES ('20', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/ums_member', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-14 20:00:01');
INSERT INTO `sys_oper_log` VALUES ('21', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/ums_member', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-18 13:45:37');
INSERT INTO `sys_oper_log` VALUES ('22', '会员', '1', 'com.aaa.repast.admin.project.system.member.controller.MemberController.addSave()', '1', 'admin', '研发部门', '/system/member/add', '127.0.0.1', '内网IP', '{\"shopId\":[\"5432\"],\"memberLevelId\":[\"45\"],\"username\":[\"vf\"],\"password\":[\"123456\"],\"nickname\":[\"111\"],\"phone\":[\"14241\"],\"status\":[\"0\"],\"createTime\":[\"2019-07-20\"],\"icon\":[\"43\"],\"gender\":[\"1\"],\"birthday\":[\"2012-12-12\"],\"city\":[\"\"],\"job\":[\"\"],\"personalizedSi', '0', null, '2019-11-18 13:51:01');
INSERT INTO `sys_oper_log` VALUES ('23', '会员', '3', 'com.aaa.repast.admin.project.system.member.controller.MemberController.remove()', '1', 'admin', '研发部门', '/system/member/remove', '127.0.0.1', '内网IP', '{\"ids\":[\"1\"]}', '0', null, '2019-11-18 13:51:27');
INSERT INTO `sys_oper_log` VALUES ('24', '会员', '1', 'com.aaa.repast.admin.project.system.member.controller.MemberController.addSave()', '1', 'admin', '研发部门', '/system/member/add', '127.0.0.1', '内网IP', '{\"shopId\":[\"1234\"],\"memberLevelId\":[\"\"],\"username\":[\"\"],\"password\":[\"\"],\"nickname\":[\"\"],\"phone\":[\"\"],\"status\":[\"\"],\"createTime\":[\"\"],\"icon\":[\"\"],\"gender\":[\"\"],\"birthday\":[\"\"],\"city\":[\"\"],\"job\":[\"\"],\"personalizedSignature\":[\"\"],\"sourceType\":[\"\"],\"integrati', '0', null, '2019-11-18 13:51:34');
INSERT INTO `sys_oper_log` VALUES ('25', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/ums_member', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-18 13:57:32');
INSERT INTO `sys_oper_log` VALUES ('26', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/ums_member', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-18 14:02:30');
INSERT INTO `sys_oper_log` VALUES ('27', '菜单管理', '2', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.editSave()', '1', 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\"menuId\":[\"2020\"],\"parentId\":[\"1\"],\"menuType\":[\"C\"],\"menuName\":[\"会员\"],\"url\":[\"/system/member\"],\"perms\":[\"system:member:view\"],\"orderNum\":[\"1\"],\"icon\":[\"#\"],\"visible\":[\"0\"]}', '0', null, '2019-11-18 14:05:07');
INSERT INTO `sys_oper_log` VALUES ('28', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2015', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-18 14:05:47');
INSERT INTO `sys_oper_log` VALUES ('29', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2019', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-18 14:05:59');
INSERT INTO `sys_oper_log` VALUES ('30', '菜单管理', '3', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.remove()', '1', 'admin', '研发部门', '/system/menu/remove/2018', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-18 14:06:11');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '豆豆', '00', '86521760@qq.com', '18538062907', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-11-18 14:10:32', 'admin', '2018-03-16 11:33:00', 'ry', '2019-11-18 14:10:31', '管理员');
INSERT INTO `sys_user` VALUES ('3', '108', 'chenjian', '陈建', '00', 'chenjian3822515@163.com', '18538062906', '0', '', '46894954cd34c0fbd454a5083bd886f1', '4bd21f', '0', '0', '127.0.0.1', '2019-08-07 12:31:29', 'admin', '2019-04-18 11:48:31', 'admin', '2019-08-07 12:31:29', '');
INSERT INTO `sys_user` VALUES ('4', '103', 'zhangsan', '张三', '00', '86587432@qq.com', '18538062999', '0', '', '9da8d52c4a42978c876621546ccf298e', '6ac61b', '0', '0', '127.0.0.1', '2019-08-07 16:24:29', 'admin', '2019-08-07 15:46:18', '', '2019-08-07 16:24:29', '');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('c24f9a1c-9319-4210-af35-4d160f4e07b7', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 7', 'on_line', '2019-11-18 14:10:25', '2019-11-18 14:10:32', '1800000');
...
CREATE TABLE `ums_admin` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `pid` bigint(20) DEFAULT NULL COMMENT '父账号ID',
  `username` varchar(64) DEFAULT NULL COMMENT '后台用户名',
  `password` varchar(64) DEFAULT NULL COMMENT '后台用户密码',
  `icon` varchar(500) DEFAULT NULL COMMENT '头像',
  `phone` varchar(255) DEFAULT NULL COMMENT '后台用户手机号',
  ...
  `type` varchar(255) DEFAULT NULL COMMENT '账号类型：0->管理员，1-> 代理商，2-> 商家管理员',
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
...
CREATE TABLE `ums_admin_login_log` (
  ...
  `create_time` datetime DEFAULT NULL,
  `ip` varchar(64) DEFAULT NULL COMMENT '后台用户ip地址',
  `address` varchar(100) DEFAULT NULL COMMENT '后台用户登陆地址',
  `user_agent` varchar(100) DEFAULT NULL COMMENT '浏览器登录类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='后台用户登录日志表';
...
CREATE TABLE `ums_admin_member_tree` (
  `ancestor` bigint(20) NOT NULL COMMENT '祖先后台用户的id',
  `descendant` bigint(20) NOT NULL COMMENT '后裔后台用户的id',
  PRIMARY KEY (`ancestor`,`descendant`),
  KEY `descendant` (`descendant`),
  CONSTRAINT `ums_admin_member_tree_ibfk_1` FOREIGN KEY (`descendant`) REFERENCES `ums_admin` (`id`),
  CONSTRAINT `ums_admin_member_tree_ibfk_2` FOREIGN KEY (`ancestor`) REFERENCES `ums_admin` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='后台管理员父子关系表';

-- ----------------------------
-- Records of ums_admin_member_tree
-- ----------------------------
...
CREATE TABLE `ums_admin_permission_relation` (
  ...
  `type` int(1) DEFAULT NULL COMMENT '-1 为减权限，1为加权限',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='后台用户和权限关系表(除角色中定义的权限以外的加减权限)';
...
CREATE TABLE `ums_agent_informaion` (
  ...
  `start_time` datetime DEFAULT NULL,
  `end_time` datetime DEFAULT NULL,
  `status` int(11) DEFAULT NULL COMMENT '代理状态',
...
CREATE TABLE `ums_contract` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='合同表(合约表)';
...
CREATE TABLE `ums_contract_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='合同(合约)模板表';
...
-- ----------------------------
INSERT INTO `ums_member` VALUES ('2', '1234', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
CREATE TABLE `ums_member_level` (
  ...
  `growth_point` int(11) DEFAULT NULL COMMENT '会员等级成长值',
...
CREATE TABLE `ums_member_login_log` (
  ...
  `member_id` bigint(20) DEFAULT NULL COMMENT '会员id',
  `create_time` datetime DEFAULT NULL,
  `ip` varchar(64) DEFAULT NULL COMMENT '登陆IP地址',
  `city` varchar(64) DEFAULT NULL COMMENT '登陆城市',
  `login_type` int(1) DEFAULT NULL COMMENT '登录类型：0->PC；1->android;2->ios;3->小程序',
  `province` varchar(64) DEFAULT NULL COMMENT '登陆的省',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ums_member_statistics_info` (
  ...
  `collect_product_count` int(11) DEFAULT NULL COMMENT '被收藏商品数量',
  `collect_subject_count` int(11) DEFAULT NULL COMMENT '被收藏主题数量',
  `collect_topic_count` int(11) DEFAULT NULL COMMENT '被收藏话题数量',
  `collect_comment_count` int(11) DEFAULT NULL COMMENT '被收藏评论数量',
...
CREATE TABLE `ums_member_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `shop_id` bigint(20) DEFAULT NULL COMMENT '店铺id',
  `name` varchar(100) DEFAULT NULL COMMENT '会员任务名称',
...
CREATE TABLE `ums_message` (
  ...
  `send_to` bigint(20) DEFAULT NULL COMMENT '该字段不为null 时为接受消息的用户ID(定向推送)',
...
CREATE TABLE `ums_permission` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='后台用户权限表';
...
CREATE TABLE `ums_shop_facility` (
  ...
  `shop_id` bigint(20) DEFAULT NULL COMMENT '店铺id',
  `title` varchar(255) DEFAULT NULL COMMENT '设施标题',
...
CREATE TABLE `ums_shop_information` (
  ...
  `lng` varchar(255) DEFAULT NULL COMMENT '店铺位置经度',
  `lat` varchar(255) DEFAULT NULL COMMENT '店铺位置纬度',
...
CREATE TABLE `ums_shop_questionnaire_answer` (
  ...
  `title` varchar(255) DEFAULT NULL COMMENT '问卷回答标题',
